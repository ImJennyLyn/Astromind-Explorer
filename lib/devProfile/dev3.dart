...
class dev3 extends StatelessWidget {
  const dev3({Key? key});
  ...
  void _launchFacebook() async {
    launch('https://www.facebook.com/jennylyn.vallador/');
  }

  void _launchTwitter() async {
    launch('https://twitter.com/LynVallado19341');
  }

  void _launchInstagram() async {
    launch('hhttps://www.instagram.com/jnny.lynnn/');
  }
}
