...
class dev2 extends StatelessWidget {
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(height: 10),
                        Text(
                          'a 3rd year computer science student, adept Application Developer with Flutter, HTML,CSS, JavaScript.',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontFamily: 'SourceCodePro',
                            fontSize: 14,
  ...
  void _launchFacebook() async {
    launch('https://www.facebook.com/profile.php?id=100012482412248');
  }

  void _launchTwitter() async {
    launch('https://twitter.com/search?q=cjangcaya&src=typed_query');
  }

  void _launchInstagram() async {
    launch('https://www.instagram.com/cjangcaya_mikuhatsune/');
  }
}
