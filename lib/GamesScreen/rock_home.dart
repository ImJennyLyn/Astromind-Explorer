...
import 'package:finalproject/rock_paper_scissors.dart';
...
class RockHome extends StatelessWidget {
  AudioPlayer audioPlayer = AudioPlayer();
  RockHome({Key? key}) : super(key: key);
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => RockPaperScissorsApp()),
                    );
                  },
