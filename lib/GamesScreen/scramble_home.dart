...
import 'package:finalproject/wordscrambleGame/word_scramble.dart';
...
class ScrambleHome extends StatelessWidget {
  AudioPlayer audioPlayer = AudioPlayer();
  ScrambleHome({Key? key}) : super(key: key);
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage(
                'images/scramble.png'), // Replace with your image path
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
            ...
            children: [
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    audioPlayer.play(AssetSource('trans.mp3'));

                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => WordScrambleApp()),
                    );
                  },
