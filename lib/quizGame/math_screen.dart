...
class _MathScreenState extends State<MathScreen> {
  ...
  List<Map<String, Object>> questions = [
    {
      'question': 'What is the result of 10 x 25 ?',
      'answers': ['150', '250,', '225'],
      'correctAnswer': '250',
    },
    {
    ...
    if (selectedAnswer != null) {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          if (!isCorrect) {
            // Play incorrect sound for wrong answers
            audioPlayer.play(AssetSource(
              'wrong.mp3',
            ));
            ...
            // Play correct sound for right answers
            audioPlayer.play(AssetSource(
              'correct.mp3',
            ));
          }
        ...
        body: Center(
          child: Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                    'images/backgroundimage/Q2.gif'), // Replace with your image asset path
                fit: BoxFit.cover,
              ),
            ),
            child: Padding(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        colors: [
                          Color.fromARGB(255, 89, 4, 92),
                          Color.fromARGB(255, 60, 8, 113),
                        ],
                        begin: Alignment.centerLeft,
                        end: Alignment.centerRight,
                      ),
